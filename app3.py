...
if selected_tab == "CONTATOS":
    ...
    try:
        ...
        status = st.sidebar.multiselect(
            "Status", df[col_status].unique(), default=df[col_status].unique()
        )
        ...
        create_download_button(df_filtrado, "contatos.csv")
